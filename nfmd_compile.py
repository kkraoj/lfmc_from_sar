...
for file in os.listdir('fuel_moisture/raw_29_apr_2019'):
    df = df.append([pd.read_table('fuel_moisture/raw_29_apr_2019/'+file)], ignore_index = True)
df.drop('Unnamed: 7', axis = 1, inplace = True)
df.columns = df.columns.str.lower()
df.to_pickle('fmc_04-29-2019')
