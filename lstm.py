...
INPUTNAME = 'lstm_input_data_pure+all_same_28_may_2019_res_SM_gap_3M'
...
if RELOADINPUT:
    ...
    dataset = make_df(resolution = RESOLUTION, max_gap = MAXGAP, lag = LAG, inputs = inputs)    
...
#     for col in dataset.columns.str.contains('forest_cover'):
