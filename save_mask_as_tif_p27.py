...
zz[:] = 0
zz[df.lat_index.values,df.lon_index.values] = df['mask'].values
...
output_raster = gdal.GetDriverByName('GTiff').Create(r'D:\Krishna\projects\vwc_from_radar\data\map\mask.tif',ncols, nrows, 1 ,gdal.GDT_Float32)  # Open the file
